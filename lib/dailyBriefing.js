...
export function getDailyDriverBriefing() {
  ...
  return {
    ...
    weatherCaution:
      "Check the Weather Intelligence section below for NWS forecast data when available — not real-time observations. This briefing preview uses sample narrative only; verify conditions with weather.gov or a trusted app before driving.",
